...
import { navLinks } from "../../static/navData";
...
const whitePath = [
  ...
  return (
    <nav className={`absolute top-0 p-4 px-6 flex z-50 justify-between w-full md:items-center  md:flex-row flex-col ${whitePath.includes(location.pathname) ? "text-[#fff]" : ""}`}>
